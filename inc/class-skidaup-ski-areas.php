...
class SkiDaUP_Ski_Areas {
	...
	public function register_cpt() {
		$labels = array(
			'name'               => _x( 'Ski Areas', 'post type general name', 'skidaup' ),
			'singular_name'      => _x( 'Ski Area', 'post type singular name', 'skidaup' ),
			'menu_name'          => _x( 'Ski Areas', 'admin menu', 'skidaup' ),
			'name_admin_bar'     => _x( 'Ski Area', 'add new on admin bar', 'skidaup' ),
			'add_new'            => _x( 'Add New', 'Ski Area', 'skidaup' ),
	   ...
	   <g>
		...
		register_post_type( 'skidaup_ski_area', $args );
	}
